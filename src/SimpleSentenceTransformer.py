...
This transformer model is chosen because it has been trained specifically for senetence embeddings.
The forward function simply calls this model to encode sentences.
Since the selected model already provides senetence level embedding, we do not need to pool the output.
